...
import com.example.wbhealth.model.Funcionario;
...
public class FuncionarioRepository implements Repositorio<Integer, Funcionario> {
    ...
    public void cadastrar(Funcionario funcionario) throws BancoDeDadosException {
        ...
        try {
            ...
            stPesssoa.setDate(4, Date.valueOf(funcionario.getDataNascimento()));
        ...
        try {
            ...
            if (!camposAtualizados.isEmpty()) {
                ...
                if (funcionario != null) {
                    ...
                    if (funcionario.getDataNascimento() != null) {
                        st.setDate(index++, Date.valueOf(funcionario.getDataNascimento()));
                    }
                    if (funcionario.getCpf() != null) {
